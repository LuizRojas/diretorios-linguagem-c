...
int main(){
    ...
    do {
        ...
        printf("8.1  Editar Arquivo\n");
        printf("9.   Excluir Arquivo\n");
        printf("10.  Sair\n");
        printf("================================\n");
        printf("Escolha uma opcao: ");
        
        // Lê a opção como string para aceitar 8.1
        char opcaoStr[10];
        scanf("%s", opcaoStr);
        
        // Converte para número ou trata o caso especial 8.1
        if (strcmp(opcaoStr, "8.1") == 0) {
            opcao = 81; // Código interno para editar arquivo
        } else {
            opcao = atoi(opcaoStr);
        }
        ...
        case 81: // Opção 8.1 - Editar Arquivo
            printf("\nDigite o nome do arquivo a editar: ");
            fgets(nomeDigitado, 100, stdin);
            nomeDigitado[strcspn(nomeDigitado, "\n")] = 0; // Remove o \n
            editarArquivo(diretorioAtual, nomeDigitado);
            break;
